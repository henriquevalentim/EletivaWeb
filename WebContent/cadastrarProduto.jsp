						...
						<div class="account-pages">
							<div class="account-box">
								...
								<div class="account-content">
									<form class="form-horizontal" action="ControleProduto?opcao=salvar"
										method="POST" name="formProduto">

										<div class="form-group m-b-20">
											<div class="col-xs-12">
												<label for="nome">Nome</label> <input class="form-control"
													type="text" name="txtNome" id="txtNome" required="required"
										...
										<div class="form-group m-b-20">
											<div class="col-xs-12">
												<label for="descricao">Descrição</label> <input
													...
													id="txtDescricao" required="required"
										...
										<div class="form-group m-b-20">
											<div class="col-xs-12">
												<label for="preço compra">Preço Compra</label> <input
													...
													name="txtPrecoCompra" id="txtPrecoCompra"
													placeholder="10,90">
											</div>
										</div>
