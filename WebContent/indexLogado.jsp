				...
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item dropdown"><a
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							<a class="dropdown-item" href="ControleCliente?id=<%= usuario.getId() %>&opcao=buscar">Minha conta</a> 
			...
			<div class="caixaProduto">
				<div class="caixaInternaProduto">
					<div class="fotoProduto">
						<a href="produtoLogado.jsp?produto=${ produto.id }"><img
							src="${ produto.urlFoto }" width="200" height="200"></a>
					</div>

					<div class="nomeProduto">
						<a href="produtoLogado.jsp?produto=${ produto.id }"
							style="color: black;">
							<h5>${ produto.nome }</h5>
						</a>
					</div>
					...
					<div class="precoProduto">
						<h5 style="color: red; font-size: 16px;">10 x R$ ${ produto.precoVenda }
						</h5>
					...
					<div class="precoProduto">
						<h5 style="color: green; font-size: 16px;">à vista ${ produto.precoVenda }
						</h5>
