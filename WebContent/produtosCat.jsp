					...
					<ul class="navbar-nav mr-auto">
						...
						<li class="nav-item dropdown" style="margin-left: 100px;"><a
							...
							<div class="dropdown-menu" aria-labelledby="navbarDropdown">
								<a class="dropdown-item" href="produtosCat.jsp?categoria=3">Consoles</a> <a
									class="dropdown-item" href="produtosCat.jsp?categoria=1">Jogos</a> <a
									class="dropdown-item" href="produtosCat.jsp?categoria=2">Acessorios</a>
							</div></li>
						...
						<li class="nav-item dropdown" style="margin-left: 50px;"><a
							...
							<div class="dropdown-menu" aria-labelledby="navbarDropdown">
								<a class="dropdown-item" href="produtosCat.jsp?categoria=6">Consoles</a> <a
									class="dropdown-item" href="produtosCat.jsp?categoria=4">Jogos</a> <a
									class="dropdown-item" href="produtosCat.jsp?categoria=5">Acessorios</a>
							</div></li>
						...
						<li class="nav-item dropdown" style="margin-left: 50px;"><a
							...
							<div class="dropdown-menu" aria-labelledby="navbarDropdown">
								<a class="dropdown-item" href="produtosCat.jsp?categoria=9">Consoles</a> <a
									class="dropdown-item" href="produtosCat.jsp?categoria=7">Jogos</a> <a
									class="dropdown-item" href="produtosCat.jsp?categoria=8">Acessorios</a>
							</div></li>
					</ul>
				</div>
			</nav>
		...
		<div class="caixaProduto">
			<div class="caixaInternaProduto">
				<div class="fotoProduto">
					<a href="produto.jsp?produto=<%= produto.getId() %>"><img
						src="<%= produto.getUrlFoto() %>" width="200" height="200"></a>
				</div>

				<div class="nomeProduto">
					<a href="produto.jsp?produto=<%= produto.getId() %>" style="color: black;">
				...
				<div class="precoProduto" style="top: 0px;">
					<button type="button" class="btn btn-success">
						<a href="produto.jsp?produto=<%= produto.getId() %>" style="color: #FFF;">Comprar</a>
					</button>
				</div>
			</div>
		</div>
